describe('formlyValidator contain validator', () => {
    //
    // vars
    //
    ...
    it('should be truthy if string contain one of phrases', () => {
        compile(['bar', 'baz']);
        expect(validate("foobaz")).toBeTruthy();
    });
