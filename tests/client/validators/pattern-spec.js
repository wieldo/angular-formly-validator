describe('formlyValidator pattern validator', function () {
    // injectables
    ...
    it('should be falsy on numbers', function () {
    ...
    it('should be falsy on mixed strings', function () {
    ...
    it('should be falsy on string with special characters', function () {
